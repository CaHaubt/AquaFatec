          ...
          children: [
            if (widget.moduleName == 'pH') ...{
              ...
              ExclamationBox(
                ...
                value: "7 mg/L",
                fontSize: 16.0,
                additionalText: "O OD (Oxigênio Dissolvido) mede a quantidade de oxigênio presente na água, sendo essencial para a sobrevivência dos peixes e o funcionamento das bactérias benéficas que convertem os resíduos dos peixes em nutrientes para as plantas.\n\nManter níveis adequados de OD (geralmente acima de 5 mg/L) é vital para evitar o estresse dos peixes e garantir que o ciclo aquapônico funcione corretamente.",
              ),
